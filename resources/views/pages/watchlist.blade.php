            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400 uppercase">issam
                            moumou</span>
                    </div>
                </li>
            </ol>
        ...
        <section class="my-10 lg:flex lg:gap-4 lg:justify-center">
            ...
            <div class="lg:w-[80%]">
                ...
                <div class="text-bold flex flex-col gap-5 md:flex-row md:gap-0 md:justify-between md:items-center">
                    <h2 class="text-white font-bold text-3xl">Watchlist <i
                            class="fa-solid fa-heart text-3xl text-red-500"></i>
                        ...
                        <div class="relative">
                            ...
                            <a href=""
                                class="absolute text-white left-3 top-3 text-2xl hover:text-red-500 duration-500"><i
                                    class="fa-solid fa-rectangle-xmark text-red-500"></i></a>
                        </div>
                        <div class="my-2">
