    ...
    <div class="w-container m-auto">
        ...
        <nav class="flex justify-center mt-10" aria-label="Page navigation example">
            {{-- <ul class="inline-flex -space-x-px">
                <li>
                    <a href="#" class="px-3 py-2 ml-0 leading-tight border border-gray-300 rounded-l-lg bg-color-primary-75 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">Previous</a>
                </li>
                <li>
                    <a href="#" class="px-3 py-2 leading-tight border border-gray-300 bg-color-primary-75 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">1</a>
                </li>
                <li>
                    <a href="#" class="px-3 py-2 leading-tight border border-gray-300 bg-color-primary-75 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">2</a>
                </li>
                <li>
                    <a href="#" aria-current="page" class="px-3 py-2 border border-gray-300 border-gray-700 bg-gray-700 text-white">3</a>
                </li>
                <li>
                    <a href="#" class="px-3 py-2 leading-tight border border-gray-300 bg-color-primary-75 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">4</a>
                </li>
                <li>
                    <a href="#" class="px-3 py-2 leading-tight border border-gray-300 bg-color-primary-75 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">5</a>
                </li>
                <li>
                    <a href="#" class="px-3 py-2 ml-0 leading-tight border border-gray-300 rounded-r-lg bg-color-primary-75 border-gray-700 text-gray-400 hover:bg-gray-700 hover:text-white">Next</a>
                </li>
            </ul> --}}
