    ...
    <div class="w-container m-auto">
        ...
        <div class="mt-7">
            ...
            <div class="mb-4 border-b dark:border-gray-700">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab"
                    ...
                    <li class="mr-2" role="presentation">
                        <a href="" class="inline-block p-4 border-b-2 rounded-t-lg text-color-links" id="session1-tab"
                            data-tabs-target="#session1" type="button" role="tab" aria-controls="session1"
                            aria-selected="false">Session 1</a>
                    </li>
                    <li class="mr-2" role="presentation">
                        <a href="" class="inline-block p-4 border-b-2 rounded-t-lg text-color-links" id="session2-tab"
                            data-tabs-target="#session2" type="button" role="tab" aria-controls="session2"
            ...
            <div id="myTabContent">
                ...
                <div class="hidden p-4 rounded-lg text-center bg-color-primary-75" id="session1" role="tabpanel"
                    aria-labelledby="session-tab">
                    <button type="button"
                        class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-14 py-2.5 text-center mr-2 mb-2">Episode
                        1</button>
                </div>
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="session2" role="tabpanel"
